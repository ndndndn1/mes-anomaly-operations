...
payload = {"lineId": "smoke", "equipmentId": "press-1", "limits": {"temperature": {"low": 10, "high": 80}}, "samples": samples}
request = urllib.request.Request("http://127.0.0.1:8802/api/judge", data=json.dumps(payload).encode(), headers={"content-type": "application/json"})
